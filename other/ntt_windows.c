...
char *getString() {
    char *computersystemName = executeCommand("wmic computersystem get name");
    char *baseboardSerial = executeCommand("wmic baseboard get serialnumber");
    char *diskDriveSerial = executeCommand("wmic diskdrive get serialnumber");
